...
RSpec.describe Project, type: :model do
  ...
  describe 'instance methods' do
    ...
    it '#challenge_theme' do
      ...
      expect(@lit_fit.challenge_theme).to eq(@furniture_challenge.theme)
    end
    ...
    it '#avg_exp' do
      expect(@news_chic.avg_exp).to eq(((@jay.years_of_experience + @gretchen.years_of_experience).to_f / 2).round(1))
      expect(@lit_fit.avg_exp).to eq(0)
    end
  end
end
